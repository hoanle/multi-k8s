...
kubectl set image deployments/server-deployment client=hoanlezuhlke/multi-d1-server:$SHA
kubectl set image deployments/worker-deployment worker=hoanlezuhlke/multi-d1-worker:$SHA
